// Benchmark "c432.blif" written by ABC on Sat Feb 20 04:39:51 2021
...
module \c432.blif  ( 
  ...
  OAI211 g004(.A0(new_n47_), .A1(G24gat), .B0(new_n46_), .B1(G1gat), .Y(new_n48_));
  ...
  OAI211 g025(.A0(new_n68_), .A1(new_n48_), .B0(new_n44_), .B1(G11gat), .Y(new_n69_));
  ...
  OAI211 g046(.A0(new_n89_), .A1(new_n87_), .B0(new_n85_), .B1(new_n83_), .Y(new_n90_));
  ...
  OAI211 g053(.A0(new_n96_), .A1(new_n94_), .B0(new_n93_), .B1(new_n91_), .Y(new_n97_));
  ...
  OAI211 g062(.A0(new_n105_), .A1(new_n103_), .B0(new_n101_), .B1(new_n99_), .Y(new_n106_));
  ...
  OAI211 g109(.A0(new_n152_), .A1(new_n150_), .B0(new_n147_), .B1(new_n145_), .Y(new_n153_));
  ...
  OAI211 g155(.A0(new_n198_), .A1(new_n129_), .B0(new_n196_), .B1(new_n125_), .Y(new_n199_));
