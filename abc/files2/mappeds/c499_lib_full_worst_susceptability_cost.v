// Benchmark "c499.blif" written by ABC on Fri Mar  5 05:07:44 2021
...
module \c499.blif  ( 
  ...
  XOR2   g001(.A(Gid4), .B(Gid0), .Y(new_n75_));
  XOR2   g002(.A(Gid12), .B(Gid8), .Y(new_n76_));
  XOR2   g003(.A(new_n76_), .B(new_n75_), .Y(new_n77_));
  INV    g004(.A(new_n77_), .Y(new_n78_));
  NAND2  g005(.A(Gr), .B(Gic0), .Y(new_n79_));
  XOR2   g006(.A(Gid17), .B(Gid16), .Y(new_n80_));
  XOR2   g007(.A(Gid19), .B(Gid18), .Y(new_n81_));
  XOR2   g008(.A(new_n81_), .B(new_n80_), .Y(new_n82_));
  XOR2   g009(.A(Gid21), .B(Gid20), .Y(new_n83_));
  XOR2   g010(.A(Gid23), .B(Gid22), .Y(new_n84_));
  ...
  XOR2   g015(.A(Gid7), .B(Gid3), .Y(new_n89_));
  XOR2   g016(.A(Gid15), .B(Gid11), .Y(new_n90_));
  XOR2   g017(.A(new_n90_), .B(new_n89_), .Y(new_n91_));
  NAND2  g018(.A(Gr), .B(Gic3), .Y(new_n92_));
  XOR2   g019(.A(Gid29), .B(Gid28), .Y(new_n93_));
  XOR2   g020(.A(Gid31), .B(Gid30), .Y(new_n94_));
  ...
  XOR2   g025(.A(Gid6), .B(Gid2), .Y(new_n99_));
  XOR2   g026(.A(Gid14), .B(Gid10), .Y(new_n100_));
  ...
  NAND2  g038(.A(Gr), .B(Gic1), .Y(new_n112_));
  ...
  XOR2   g054(.A(Gid20), .B(Gid16), .Y(new_n128_));
  XOR2   g055(.A(Gid28), .B(Gid24), .Y(new_n129_));
  ...
  NAND2  g071(.A(Gr), .B(Gic5), .Y(new_n145_));
  XOR2   g072(.A(Gid13), .B(Gid12), .Y(new_n146_));
  XOR2   g073(.A(Gid15), .B(Gid14), .Y(new_n147_));
  XOR2   g074(.A(new_n147_), .B(new_n146_), .Y(new_n148_));
  XOR2   g075(.A(Gid9), .B(Gid8), .Y(new_n149_));
  XOR2   g076(.A(Gid11), .B(Gid10), .Y(new_n150_));
  ...
  XOR2   g082(.A(Gid23), .B(Gid19), .Y(new_n156_));
  XOR2   g083(.A(Gid31), .B(Gid27), .Y(new_n157_));
  XOR2   g084(.A(new_n157_), .B(new_n156_), .Y(new_n158_));
  INV    g085(.A(new_n158_), .Y(new_n159_));
  NAND2  g086(.A(Gr), .B(Gic7), .Y(new_n160_));
  XOR2   g087(.A(new_n148_), .B(new_n134_), .Y(new_n161_));
  XOR2   g088(.A(new_n161_), .B(new_n160_), .Y(new_n162_));
  XOR2   g089(.A(new_n162_), .B(new_n159_), .Y(new_n163_));
  XOR2   g090(.A(Gid22), .B(Gid18), .Y(new_n164_));
  XOR2   g091(.A(Gid30), .B(Gid26), .Y(new_n165_));
  XOR2   g092(.A(new_n165_), .B(new_n164_), .Y(new_n166_));
  NAND2  g093(.A(Gr), .B(Gic6), .Y(new_n167_));
  XOR2   g094(.A(new_n151_), .B(new_n137_), .Y(new_n168_));
  ...
  XOR2   g099(.A(new_n172_), .B(new_n74_), .Y(God0));
  INV    g100(.A(Gid1), .Y(new_n174_));
  NAND4  g101(.A(new_n171_), .B(new_n155_), .C(new_n127_), .D(new_n119_), .Y(new_n175_));
  XOR2   g102(.A(new_n175_), .B(new_n174_), .Y(God1));
  INV    g103(.A(Gid2), .Y(new_n177_));
  NAND4  g104(.A(new_n171_), .B(new_n155_), .C(new_n127_), .D(new_n125_), .Y(new_n178_));
  XOR2   g105(.A(new_n178_), .B(new_n177_), .Y(God2));
  INV    g106(.A(Gid3), .Y(new_n180_));
  NAND4  g107(.A(new_n171_), .B(new_n155_), .C(new_n127_), .D(new_n122_), .Y(new_n181_));
  XOR2   g108(.A(new_n181_), .B(new_n180_), .Y(God3));
  INV    g109(.A(Gid4), .Y(new_n183_));
  ...
  XOR2   g114(.A(new_n187_), .B(new_n183_), .Y(God4));
  INV    g115(.A(Gid5), .Y(new_n189_));
  NAND4  g116(.A(new_n186_), .B(new_n163_), .C(new_n127_), .D(new_n119_), .Y(new_n190_));
  XOR2   g117(.A(new_n190_), .B(new_n189_), .Y(God5));
  INV    g118(.A(Gid6), .Y(new_n192_));
  NAND4  g119(.A(new_n186_), .B(new_n163_), .C(new_n127_), .D(new_n125_), .Y(new_n193_));
  XOR2   g120(.A(new_n193_), .B(new_n192_), .Y(God6));
  INV    g121(.A(Gid7), .Y(new_n195_));
  NAND4  g122(.A(new_n186_), .B(new_n163_), .C(new_n127_), .D(new_n122_), .Y(new_n196_));
  XOR2   g123(.A(new_n196_), .B(new_n195_), .Y(God7));
  INV    g124(.A(Gid8), .Y(new_n198_));
  ...
  XOR2   g130(.A(new_n203_), .B(new_n198_), .Y(God8));
  INV    g131(.A(Gid9), .Y(new_n205_));
  NAND4  g132(.A(new_n202_), .B(new_n171_), .C(new_n127_), .D(new_n119_), .Y(new_n206_));
  XOR2   g133(.A(new_n206_), .B(new_n205_), .Y(God9));
  INV    g134(.A(Gid10), .Y(new_n208_));
  NAND4  g135(.A(new_n202_), .B(new_n171_), .C(new_n127_), .D(new_n125_), .Y(new_n209_));
  XOR2   g136(.A(new_n209_), .B(new_n208_), .Y(God10));
  INV    g137(.A(Gid11), .Y(new_n211_));
  NAND4  g138(.A(new_n202_), .B(new_n171_), .C(new_n127_), .D(new_n122_), .Y(new_n212_));
  XOR2   g139(.A(new_n212_), .B(new_n211_), .Y(God11));
  INV    g140(.A(Gid12), .Y(new_n214_));
  ...
  XOR2   g143(.A(new_n216_), .B(new_n214_), .Y(God12));
  INV    g144(.A(Gid13), .Y(new_n218_));
  NAND4  g145(.A(new_n215_), .B(new_n163_), .C(new_n127_), .D(new_n119_), .Y(new_n219_));
  XOR2   g146(.A(new_n219_), .B(new_n218_), .Y(God13));
  INV    g147(.A(Gid14), .Y(new_n221_));
  NAND4  g148(.A(new_n215_), .B(new_n163_), .C(new_n127_), .D(new_n125_), .Y(new_n222_));
  XOR2   g149(.A(new_n222_), .B(new_n221_), .Y(God14));
  INV    g150(.A(Gid15), .Y(new_n224_));
  NAND4  g151(.A(new_n215_), .B(new_n163_), .C(new_n127_), .D(new_n122_), .Y(new_n225_));
  XOR2   g152(.A(new_n225_), .B(new_n224_), .Y(God15));
  INV    g153(.A(Gid16), .Y(new_n227_));
  ...
  XOR2   g163(.A(new_n236_), .B(new_n227_), .Y(God16));
  INV    g164(.A(Gid17), .Y(new_n238_));
  NAND4  g165(.A(new_n235_), .B(new_n154_), .C(new_n229_), .D(new_n228_), .Y(new_n239_));
  XOR2   g166(.A(new_n239_), .B(new_n238_), .Y(God17));
  INV    g167(.A(Gid18), .Y(new_n241_));
  NAND4  g168(.A(new_n235_), .B(new_n185_), .C(new_n229_), .D(new_n228_), .Y(new_n242_));
  XOR2   g169(.A(new_n242_), .B(new_n241_), .Y(God18));
  INV    g170(.A(Gid19), .Y(new_n244_));
  NAND4  g171(.A(new_n235_), .B(new_n163_), .C(new_n229_), .D(new_n228_), .Y(new_n245_));
  XOR2   g172(.A(new_n245_), .B(new_n244_), .Y(God19));
  INV    g173(.A(Gid20), .Y(new_n247_));
  ...
  XOR2   g176(.A(new_n249_), .B(new_n247_), .Y(God20));
  INV    g177(.A(Gid21), .Y(new_n251_));
  NAND4  g178(.A(new_n235_), .B(new_n154_), .C(new_n248_), .D(new_n122_), .Y(new_n252_));
  XOR2   g179(.A(new_n252_), .B(new_n251_), .Y(God21));
  INV    g180(.A(Gid22), .Y(new_n254_));
  NAND4  g181(.A(new_n235_), .B(new_n185_), .C(new_n248_), .D(new_n122_), .Y(new_n255_));
  XOR2   g182(.A(new_n255_), .B(new_n254_), .Y(God22));
  INV    g183(.A(Gid23), .Y(new_n257_));
  NAND4  g184(.A(new_n235_), .B(new_n163_), .C(new_n248_), .D(new_n122_), .Y(new_n258_));
  XOR2   g185(.A(new_n258_), .B(new_n257_), .Y(God23));
  INV    g186(.A(Gid24), .Y(new_n260_));
  NOR2   g187(.A(new_n115_), .B(new_n88_), .Y(new_n261_));
  NAND4  g188(.A(new_n235_), .B(new_n200_), .C(new_n229_), .D(new_n261_), .Y(new_n262_));
  XOR2   g189(.A(new_n262_), .B(new_n260_), .Y(God24));
  INV    g190(.A(Gid25), .Y(new_n264_));
  NAND4  g191(.A(new_n235_), .B(new_n154_), .C(new_n229_), .D(new_n261_), .Y(new_n265_));
  XOR2   g192(.A(new_n265_), .B(new_n264_), .Y(God25));
  INV    g193(.A(Gid26), .Y(new_n267_));
  NAND4  g194(.A(new_n235_), .B(new_n185_), .C(new_n229_), .D(new_n261_), .Y(new_n268_));
  XOR2   g195(.A(new_n268_), .B(new_n267_), .Y(God26));
  INV    g196(.A(Gid27), .Y(new_n270_));
  NAND4  g197(.A(new_n235_), .B(new_n163_), .C(new_n229_), .D(new_n261_), .Y(new_n271_));
  XOR2   g198(.A(new_n271_), .B(new_n270_), .Y(God27));
  INV    g199(.A(Gid28), .Y(new_n273_));
  ...
  XOR2   g202(.A(new_n275_), .B(new_n273_), .Y(God28));
  INV    g203(.A(Gid29), .Y(new_n277_));
  NAND4  g204(.A(new_n235_), .B(new_n154_), .C(new_n274_), .D(new_n122_), .Y(new_n278_));
  XOR2   g205(.A(new_n278_), .B(new_n277_), .Y(God29));
  INV    g206(.A(Gid30), .Y(new_n280_));
  NAND4  g207(.A(new_n235_), .B(new_n185_), .C(new_n274_), .D(new_n122_), .Y(new_n281_));
  XOR2   g208(.A(new_n281_), .B(new_n280_), .Y(God30));
  INV    g209(.A(Gid31), .Y(new_n283_));
  NAND4  g210(.A(new_n235_), .B(new_n163_), .C(new_n274_), .D(new_n122_), .Y(new_n284_));
  XOR2   g211(.A(new_n284_), .B(new_n283_), .Y(God31));
endmodule
