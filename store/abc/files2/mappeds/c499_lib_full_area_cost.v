// Benchmark "c499.blif" written by ABC on Fri Mar  5 05:07:38 2021
...
module \c499.blif  ( 
  ...
  NAND2  g016(.A(Gr), .B(Gic3), .Y(new_n90_));
  ...
  NAND2  g027(.A(Gr), .B(Gic2), .Y(new_n101_));
  ...
  NAND2  g060(.A(Gr), .B(Gic4), .Y(new_n134_));
  ...
  NAND2  g074(.A(Gr), .B(Gic5), .Y(new_n148_));
  ...
  NAND2  g088(.A(Gr), .B(Gic7), .Y(new_n162_));
  ...
  NAND2  g095(.A(Gr), .B(Gic6), .Y(new_n169_));
